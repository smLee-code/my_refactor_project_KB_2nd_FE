...
<template>
  <div class="h-screen bg-gray-50 w-full flex flex-col">
    <!-- 헤더 -->
        ...
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex items-center">
            <a
              ...
              data-readdy="true"
              class="text-gray-700 hover:text-gray-900 font-medium cursor-pointer transition-colors flex items-center space-x-2"
            >
          ...
          <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <div class="space-y-4">
              ...
              <p class="text-sm text-gray-600 mb-4">
                회원님의 관심사에 맞는 금융상품을 추천해드리기 위해 필요한
                정보입니다.
              </p>
    ...
    <footer
      class="bg-gradient-to-r from-gray-100 to-gray-200 py-4 shadow-inner"
    >
      <div class="container mx-auto px-4 sm:px-6 lg:px-32">
        ...
        <div class="text-center mt-2">
          <p class="text-sm text-gray-500">
            © 2025 Fund:ing. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
