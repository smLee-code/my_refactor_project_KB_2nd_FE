...
const submitFunding = async () => {
  try {
    ...
    const jsonData = {
      ...
      loanLimit: parseInt(formData.value.loanLimit.replace(/,/g, '')),
      minInterestRate: parseFloat(formData.value.minInterestRate),
      maxInterestRate: parseFloat(formData.value.maxInterestRate),
