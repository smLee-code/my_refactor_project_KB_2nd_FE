...
const submitFunding = async () => {
  try {
    ...
    const jsonData = {
      ...
      minDonationAmount: parseInt(String(formData.value.minDonationAmount).replace(/,/g, '')) || 0,
      maxDonationAmount: parseInt(String(formData.value.maxDonationAmount).replace(/,/g, '')) || 0,
