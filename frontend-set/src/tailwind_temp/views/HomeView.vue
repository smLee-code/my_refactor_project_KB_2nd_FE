    ...
    <section class="bg-gradient-to-r from-gray-100 to-gray-200 py-16">
      <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
          <ProjectCard v-for="item in recommendedProjects" :key="item.id" :project="item" />
        </div>
      </div>
    </section>
    <!-- 마감 임박 펀딩 -->
...
const mainBanners = [
  {
    title: '첫번째 배너 타이틀',
    image:
      'https://readdy.ai/api/search-image?query=modern%20financial%20technology%20platform%20interface%20with%20clean%20design%2C%20professional%20investment%20dashboard%2C%20bright%20yellow%20accent%20colors%2C%20minimalist%20style%2C%20high%20quality%20digital%20illustration%2C%203D%20depth%20effect&width=600&height=300&seq=banner1&orientation=landscape',
  },
  {
    title: '두번째 배너 타이틀',
    image:
      'https://readdy.ai/api/search-image?query=second%20banner%20image&width=600&height=300&seq=banner2&orientation=landscape',
  },
  {
    title: '세번째 배너 타이틀',
    image:
      'https://readdy.ai/api/search-image?query=third%20banner%20image&width=600&height=300&seq=banner3&orientation=landscape',
  },
]
...
const popularFundings = [
  ...
  {
    id: 1,
    image: 'https://readdy.ai/api/search-image?query=popular%20funding%201',
    title: '인기 펀딩 1',
    description: '설명1',
    daysLeft: 10,
    category: '적금형',
  ...
  {
    id: 2,
    image: 'https://readdy.ai/api/search-image?query=popular%20funding%202',
    title: '인기 펀딩 2',
    description: '설명2',
    daysLeft: 5,
    category: '기부형',
  ...
  {
    id: 3,
    image: 'https://readdy.ai/api/search-image?query=popular%20funding%203',
    title: '인기 펀딩 3',
    description: '설명3',
    daysLeft: 2,
    category: '대출형',
...
const visibleUrgentFundings = [
  ...
  {
    id: 1,
    image: 'https://readdy.ai/api/search-image?query=urgent%20funding%201',
    title: '마감임박 펀딩 1',
    timeLeft: '3시간 남음',
    participants: 30,
    progress: 95,
  ...
  {
    id: 2,
    image: 'https://readdy.ai/api/search-image?query=urgent%20funding%202',
    title: '마감임박 펀딩 2',
    timeLeft: '1시간 남음',
    participants: 20,
    progress: 80,
