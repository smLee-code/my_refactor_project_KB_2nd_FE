    ...
    <Card :title="title" :icon="icon" :iconColor="iconColor">
        <div class="space-y-3">
            ...
            <div class="space-y-3">
                ...
                <div
                    class="bg-amber-50 rounded-lg p-3 cursor-pointer hover:bg-amber-100 transition-colors"
                    @click="goToFunding(recentFundingId)"
                >
                ...
                <div
                    class="bg-indigo-50 rounded-lg p-3 cursor-pointer hover:bg-indigo-100 transition-colors"
                    @click="goToFunding(bestFundingId)"
                >
